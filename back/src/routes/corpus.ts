  ...
  async (req: Request, res: Response): Promise<any> => {
    try {
      ...
      return res
        ...
        .json({ error: ReasonPhrases.INTERNAL_SERVER_ERROR, details: "" });
    }
  },
);
...
corpusRouter.post(
  ...
  async (req: Request, res: Response): Promise<any> => {
    ...
    try {
      ...
      return res
        .status(StatusCodes.INTERNAL_SERVER_ERROR)
        .json({ error: ReasonPhrases.NOT_IMPLEMENTED, details: error.message });
    }
  },
);
...
corpusRouter.delete(
  ...
  async (req: Request, res: Response): Promise<any> => {
    return res
      ...
      .json({ error: ReasonPhrases.NOT_IMPLEMENTED, details: "" });
  },
);
